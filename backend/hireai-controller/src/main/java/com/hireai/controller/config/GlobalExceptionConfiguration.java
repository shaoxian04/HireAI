...
public class GlobalExceptionConfiguration {
    ...
    public ResponseEntity<WebResult<Void>> handleUnreadableBody(HttpMessageNotReadableException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(WebResult.error(ResultCode.VALIDATION_ERROR, "Request body is missing or malformed"));
    }
